...
function Footer() {
  return (
    <div className='w-full flex items-center h-screen bg-zinc-900 p-20'>
        <div className='w-1/2 flex flex-col justify-between h-full'>
            <div>
            <h1 className='text-7xl font-semibold'>EYE-</h1>
            <h1 className='text-7xl font-semibold'>OPENING</h1>
            </div>
        ...
        <div className='w-1/2 flex flex-col'>
            <div>
                <h1 className='text-7xl font-semibold'>PRESENTATIONS</h1>
            </div>
            <div className='h-[35vw] pt-10'>
                <div className='w-full'>
                <h1>S:</h1>
                {["Instagram" , "Behance", "Facebook", "Linkedin"].map((item) => (
                    <h1 className='text-xl' href="">{item}</h1>
                ))}
                </div>
                <div className='w-full mt-4 flex justify-between'>
                    ...
                    <div className='w-1/2 flex flex-col justify-end ml-20'>
                        <h1>L:</h1>
                        {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((item , index) => (
                            <h1 key={index} className='text-xl'>{item}</h1>
                        ))}
